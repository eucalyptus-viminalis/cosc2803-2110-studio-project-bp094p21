...
// DO NOT MODIFY THIS
    ...
    public String ogNothing() {
        ...
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='num'>Ranking</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='string'>Country Name</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='num'>Total Cases</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='num'>Total Deaths</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='num'>Population</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='num'>Most Cases in A Day</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='string'>Date of Most Cases</th>";
        infectionsvar = infectionsvar + " </tr>";
    ...
    public String doNothingStates(String countryOrState) {
        ...
        infectionsvar = infectionsvar + " <tr>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='num'>Ranking</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='string'>Country of State</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='string'>State</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='num'>Total Cases</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='num'>Total Deaths</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='num'>Population</th>";
        infectionsvar = infectionsvar + "     <th class='btn-th' data-type='num'>Most Cases in A Day</th>";
